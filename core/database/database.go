...
func connectPostgres(cfg *config.Config) (*gorm.DB, *sql.DB, error) {
	...
	if err := db.AutoMigrate(&Question{}, &QuestionCheck{}, &Ticket{}, &DailyMessage{}, &VoiceTime{}, &LOA{}, &Session{}, &ModNote{}, &ModTraining{}, &RemovedMod{}, &ModAction{}, &ModIssuedAction{}, &ManagerPermission{}, &ModPermission{}, &GameLeadAssignment{}, &GameLeadDailyMessage{}, &GameLeadVoiceTime{}, &GameLeadNote{}, &Attachment{}); err != nil {
